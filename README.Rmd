...
The following code describes al the steps required to load an process the data files to create a single file with tidy data.
```{r., cache=TRUE}
...
The following table contains all the tracked activities, including their code and name
